use crate::{
    ...
    immediate::{
        ...
        ops::{
            ...
            op_trait::ImmediateOp, remove_if_op::RemoveIfOp, remove_op::RemoveOp,
    ...
    STATE: Default + 'tx,
{
    pub fn get(
        ...
        self.ops.push(ImmediateOp::<K, V, L, STATE>::Get(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
        ...
        V: Default,
    {
        ...
        self.ops
            .push(ImmediateOp::<K, V, L, STATE>::InsertDefault(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
        ...
        V: Default,
    {
        ...
        self.ops
            .push(ImmediateOp::<K, V, L, STATE>::InsertDefaultIfAbsent(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
        ...
        K: Clone,
    {
        ...
        self.ops.push(ImmediateOp::<K, V, L, STATE>::InsertWith(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
        ...
        K: Clone,
    {
        ...
        self.ops
            .push(ImmediateOp::<K, V, L, STATE>::InsertWithIfAbsent(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
    ...
    pub fn modify(
        ...
        self.ops.push(ImmediateOp::<K, V, L, STATE>::Modify(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
        ...
        K: Clone,
    {
        ...
        self.ops.push(ImmediateOp::<K, V, L, STATE>::MoveValue(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
    ...
    pub fn remove(
        ...
        self.ops.push(ImmediateOp::<K, V, L, STATE>::Remove(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
    ...
    pub fn remove_if(
        ...
        self.ops.push(ImmediateOp::<K, V, L, STATE>::RemoveIf(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
        ...
        K: Clone,
    {
        ...
        self.ops.push(ImmediateOp::<K, V, L, STATE>::SwapValue(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
        ...
        K: Clone,
    {
        ...
        self.ops.push(ImmediateOp::<K, V, L, STATE>::Update(op));
        ImmediateTxBuilder {
            custodian: self.custodian,
            guards: self.guards,
            ops: self.ops,
