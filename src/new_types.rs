...
/// A bitmask of shard indices.
///
/// Used internally by the transaction machinery; exposed so the specialised
/// prepared transaction types generated by [`tx_schema`](macro@crate::tx_schema)
/// can be defined outside this crate.
#[doc(hidden)]
#[derive(Debug, Clone, Copy, Default, Hash, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde", serde(transparent))]
