...
pub trait TxSchema {
    ...
    /// for this schema.
    ///
    /// `PHASE` is a phase marker ([`BuilderPhase`] while the builder
    /// is still accepting guard requirements and
    /// [`BuildablePhase`](crate::BuildablePhase)
    ...
    ) -> Self::Builder<'tx, L, S, BuilderPhase>
    where
        Self: Sized + 'tx,
        L: LockPolicy + 'tx,
        S: BuildHasher + 'tx,
    ...
    (
        ...
        $crate::_paste! {
            ...
            mod [<__private $name>] {
                ...
                impl<K, V> $crate::TxSchema for $name<K, V>
                where
                    K: std::hash::Hash,
                {
                    type Key = K;
                ...
                // `BuilderPhase`); the schema itself is baked in by
                // the type name.
                pub struct [<$name Builder>]<
                    'tx,
                    SCHEMA,
                    L = $crate::MutexPolicy,
                    S = $crate::DefaultBuildHasher,
                    PHASE = $crate::BuilderPhase,
                > where
                    SCHEMA: $crate::TxSchema + 'tx,
                    L: $crate::LockPolicy,
                    S: std::hash::BuildHasher,
                {
                ...
                impl<'tx, SCHEMA, L, S>
                    [<$name Builder>]<'tx, SCHEMA, L, S, $crate::BuilderPhase>
                where
                    SCHEMA: $crate::TxSchema + 'tx,
                    L: $crate::LockPolicy,
                    S: std::hash::BuildHasher,
                {
                    ...
                    pub fn require(
                        mut self,
                        name: impl AsRef<str>,
                        key_selector: impl $crate::TxKeySelector<$crate::TxKey<SCHEMA::Key>, SCHEMA::IndexedKeys> + 'tx,
                        condition: impl Fn(
                            &SCHEMA::Key,
                            Option<&SCHEMA::Value>,
                            &SCHEMA::Params,
                    ...
                    S: std::hash::BuildHasher,
                {
                    ...
                    ) -> [<$name Builder>]<'tx, SCHEMA, L, S, $crate::BuildablePhase> {
                    ...
                    pub fn move_value(
                        mut self,
                        key_selector_from: impl $crate::TxKeySelector<$crate::TxKey<SCHEMA::Key>, SCHEMA::IndexedKeys> + 'tx,
                        key_selector_to: impl $crate::TxKeySelector<$crate::TxKey<SCHEMA::Key>, SCHEMA::IndexedKeys> + 'tx,
                    ) -> [<$name Builder>]<'tx, SCHEMA, L, S, $crate::BuildablePhase> {
                    ...
                    pub fn swap_value(
                        mut self,
                        key_selector_a: impl $crate::TxKeySelector<$crate::TxKey<SCHEMA::Key>, SCHEMA::IndexedKeys> + 'tx,
                        key_selector_b: impl $crate::TxKeySelector<$crate::TxKey<SCHEMA::Key>, SCHEMA::IndexedKeys> + 'tx,
                    ) -> [<$name Builder>]<'tx, SCHEMA, L, S, $crate::BuildablePhase> {
                ...
                where
                    ...
                    L: $crate::LockPolicy + 'tx,
                    S: std::hash::BuildHasher + 'tx,
                    [<$name Keys>]<K>: $crate::TxKeys<K, [<$name IndexedKeys>]<K>, S>,
                {
                    #[must_use]
