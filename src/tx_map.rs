    ...
    S: BuildHasher,
{
    ...
    /// Internal shard store, exposed so the prepared transaction types
    /// generated by [`tx_schema`](macro@crate::tx_schema) can be defined
    /// outside this crate.
    #[doc(hidden)]
    pub custodian: Custodian<K, V, L>,
    /// Internal hasher, exposed so the prepared transaction types generated
    /// by [`tx_schema`](macro@crate::tx_schema) can be defined outside this
    /// crate.
    #[doc(hidden)]
